...
export default function Base(): JSX.Element {
    ...
    return (
        <Fragment>
            ...
            <p>Welcome to the "T90 Community Cup 2 in Stats" website. This website collects all the statistics you could ever want to know about the tournament in one place!</p>
